...
gap is therefore a selection mechanism that adds decision-space diversity at only a
\emph{small, bounded} convergence cost instead of the full trade-off these methods pay.

\paragraph{Our key insight: placement of the diversity term in the pipeline} We address
this gap by moving the decision-space signal to a later point in selection. A generational
